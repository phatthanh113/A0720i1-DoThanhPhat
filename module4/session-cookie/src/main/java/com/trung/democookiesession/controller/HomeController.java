...
public class HomeController {
    ...
    public String createCookie(HttpServletResponse response, Model model) {
        Cookie cookie = new Cookie("userName", "TrungDoan1");
        Cookie cookie2 = new Cookie("userName", "TrungDoan2");
        Cookie cookie3 = new Cookie("userName", "TrungDoan3");
        cookie.setMaxAge(60);
    ...
    public String getCookiePage(@CookieValue(value = "userName",defaultValue = "123")String userName,
                                Model model){
